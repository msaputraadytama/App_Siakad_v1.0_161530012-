...
import java.io.IOException;//tambahkan library
...
public class FrMenu extends javax.swing.JFrame {
     ...
     */
    public FrMenu() {//method constructor
        initComponents();
        
        this.setExtendedState(this.getExtendedState () | FrMenu.MAXIMIZED_BOTH);
        disabledMenu();//pemanggilan method disabledMenu
        txtIDUser.requestFocus(true);//agar kursor fokus pd id user
    }

    private void disabledMenu(){//method yang membuat menu menjadi disable ketika pertama dijalankan
        mnSistem.setEnabled(false);
        mnMaster.setEnabled(false);
        mnMahasiswa.setEnabled(false);
    }
    
    private void enabledMenu(){//method yang membuat menu menjadi enable ketika pertama dijalankan
    ...
    private void mnProdiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnProdiActionPerformed
        IfrProdi fr = new IfrProdi();//memanggil form IfrUser
        panelMenu.add(fr);
        fr.setVisible(true);
    ...
    private void mnUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnUserActionPerformed
        IfrUsers fr = new IfrUsers();//memanggil form IfrUser
        panelMenu.add(fr);
        fr.setVisible(true);
    ...
    private void mnTAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnTAActionPerformed
        IfrTahunAngkatan fr = new IfrTahunAngkatan();//memanggil form IfrTahunAngkatan
        panelMenu.add(fr);
        fr.setVisible(true);
    ...
    private void mnJurusanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnJurusanActionPerformed
        IfrJurusan fr = new IfrJurusan();//memanggil form IfrJurusan
        panelMenu.add(fr);
        fr.setVisible(true);
